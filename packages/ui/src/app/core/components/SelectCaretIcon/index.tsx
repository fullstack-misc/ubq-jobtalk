import './select-caret-icon.scss';

type SelectCaretIconProps = {
	classPrefix: string;
};

function SelectCaretIcon({ classPrefix }: SelectCaretIconProps) {
	return (
		<span className={`${classPrefix}__circle`}>
			<svg
				className={`${classPrefix}__circle__caret`}
				width="16"
				height="16"
				viewBox="0 0 16 16"
				fill="none"
...
export default SelectCaretIcon;
